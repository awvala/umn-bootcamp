...
public class ConsoleIO {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<HashMap<String, String, String, String, String, String>> students = new ArrayList<>();
    ...
    student.put(firstname, lastname, middleInitial, address, email, phoneNumber);
  }
